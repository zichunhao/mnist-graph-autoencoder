...
class Encoder(nn.Module):
    ...
    def __init__(self, num_nodes, node_sizes, output_node_size, nums_hidden_node_layers, hidden_edge_sizes, output_edge_sizes,
        ...
        for i in range(self.num_layers-1):
            graphNet = GraphNet(num_nodess=self.num_nodes, input_node_size=self.node_sizes[i], output_node_size=self.node_sizes[i+1],
        ...
        graphNet = GraphNet(num_nodess=self.num_nodes, input_node_size=self.node_sizes[-1], output_node_size=self.output_node_size,
